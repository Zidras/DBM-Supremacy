...
--	RemoveDruidBuff				= "戰鬥開始24秒後自動移除野性印記/野性賜福",
	RemoveBuffsOnMC				= "當 $spell:71289 對施放時移除增益。每個選項都是累積的。",
	...
	EqUneqWeapons				= "當支配心智施放時，自動卸載當前武器並再結束後重新裝備。若要讓自動裝備成功運作，請使用裝備管理員功能創建一個名為\"pve\"的全套含武器裝備集",
	EqUneqTimer					= "永遠依據計時器移除武器，而非當首領唱法時。(假如延遲很高的話)強烈建議將此選項勾選"
})

L:SetMiscLocalization({
	YellReanimatedFanatic	= "起來，在純粹的形態中感受狂喜!",
	YellDominateMind		= "你脆弱而且無力抗拒我的意志!",
	ShieldPercent			= "法力屏障",
--	Fanatic1				= "神教狂熱者",
--	Fanatic2				= "畸形的狂熱者",
--	Fanatic3				= "再活化的狂熱者",
