...
--	RemoveDruidBuff				= "Снимите бафф $spell:48469 / $spell:48470 через 24 секунды после начала боя", -- Needs review
	RemoveBuffsOnMC				= "Снимать баффы, когда используется заклинание $spell:71289. Каждый вариант является кумулятивным.",
	...
	EqUneqWeapons				= "Снимать/надевать оружия если используется заклинание $spell:71289. Для надевания создайте компл. экип. \"pve\". Для снятия не нужен.",
...
L:SetMiscLocalization({
	...
	YellDominateMind		= "Ты не в силах противиться моей воле!",
...
L:SetMiscLocalization({
	...
	PullAlliance		= "Тогда выдвигаемся! Быст...", -- 37457
...
L:SetMiscLocalization({
	...
	InvocationOfBlood	= "Заклятье крови переходит к (.+)!"
--	OrbSwitchValanar	= "Заклятье крови переходит к принцу Валанару!", -- 38589
--	OrbSwitchKeleseth	= "Заклятье крови переходит к принцу Келесету!", -- 38588
--	OrbSwitchTaldaram	= "Заклятье крови переходит к принцу Талдараму!" -- 38590
})
